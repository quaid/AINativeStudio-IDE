...
class CachedPublicClientApplicationManager {
    constructor(_pcasSecretStorage, _accountAccess, _secretStorage, _logger, disposables) {
    ...
    static async create(secretStorage, logger, cloudName) {
    ...
    async _doCreatePublicClientApplication(clientId) {
        const pca = await cachedPublicClientApplication_1.CachedPublicClientApplication.create(clientId, this._secretStorage, this._accountAccess, this._logger);
