...
class CachedPublicClientApplication {
    //#endregion
    constructor(_clientId, _secretStorage, _accountAccess, _logger) {
        ...
        const loggerOptions = new loggerOptions_1.MsalLoggerOptions(_logger);
    ...
    static async create(clientId, secretStorage, accountAccess, logger) {
