...
class Model {
    ...
    constructor(git, askpass, globalState, workspaceState, logger, telemetryReporter) {
        ...
        this.historyItemDetailsProviders = new Set();
        /**
    ...
    async openRepository(repoPath, openIfClosed = false) {
        ...
        try {
            ...
            const repository = new repository_1.Repository(this.git.open(repositoryRoot, repositoryRootRealPath, dotGit, this.logger), this, this, this, this, this, this, this.globalState, this.logger, this.telemetryReporter);
