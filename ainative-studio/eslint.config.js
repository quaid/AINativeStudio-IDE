...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // AINative Studio warn -> off
			...
			// AINative Studio - this should only apply to workbench/void/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- AINative Studio
			'@stylistic/ts/member-delimiter-style': 'off', // <-- AINative Studio
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- AINative Studio
		}
	},
	// vscode TS
	{
