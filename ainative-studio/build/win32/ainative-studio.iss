...
AppSupportURL=https://www.ainative.studio/
AppUpdatesURL=https://www.ainative.studio/
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=AINativeStudio
Compression=lzma
...
WizardImageFile="{#RepoDir}\ai_native_studio_icons\inno-big.bmp,{#RepoDir}\ai_native_studio_icons\inno-big.bmp,{#RepoDir}\ai_native_studio_icons\inno-big.bmp,{#RepoDir}\ai_native_studio_icons\inno-big.bmp,{#RepoDir}\ai_native_studio_icons\inno-big.bmp,{#RepoDir}\ai_native_studio_icons\inno-big.bmp,{#RepoDir}\ai_native_studio_icons\inno-big.bmp"
WizardSmallImageFile="{#RepoDir}\ai_native_studio_icons\inno-small.bmp,{#RepoDir}\ai_native_studio_icons\inno-small.bmp,{#RepoDir}\ai_native_studio_icons\inno-small.bmp,{#RepoDir}\ai_native_studio_icons\inno-small.bmp,{#RepoDir}\ai_native_studio_icons\inno-small.bmp,{#RepoDir}\ai_native_studio_icons\inno-small.bmp,{#RepoDir}\ai_native_studio_icons\inno-small.bmp"
SetupIconFile={#RepoDir}\ai_native_studio_icons\code.ico
